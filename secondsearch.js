...
const hotelsByCategory = {
    "🎄 Новогодние туры": [
        ...
        },
        {
            ...
            price: 145000,
            stars: 4, 
            features: ["Каток", "Горки", "Новогодний ужин", "Сауна", "Танцы c Дедом Морозом"]
        },
        {
            "id": 110,
    ...
    "💍 Свадебные туры": [
        {
            ...
            price: 320000,
            stars: 5,
            features: ["Свадебный ужин при свечах", "Фотосессия на берегу моря", "Романтический декор", "Завтрак в постель"]
        },
        {
            "id": 127,
